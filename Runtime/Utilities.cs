...
namespace MessagePack
{
    ...
    internal static class Utilities
    {
        ...
        /// </summary>
        internal static NonGenericDictionaryEnumerable GetEntryEnumerator(this IDictionary dictionary) => new NonGenericDictionaryEnumerable(dictionary);
        ...
        internal struct NonGenericDictionaryEnumerable
        {
            ...
            {
                return new NonGenericDictionaryEnumerator(this.dictionary);
            }
        }
