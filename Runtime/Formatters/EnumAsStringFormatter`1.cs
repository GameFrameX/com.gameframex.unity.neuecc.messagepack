...
namespace MessagePack.Formatters
{
        ...
        where T : struct, Enum
    {
        ...
        {
            if (this.serializationToClrName != null && this.isFlags && serializedNames.IndexOf(", ", StringComparison.Ordinal) >= 0)
            {
        ...
        {
            if (this.clrToSerializationName != null && this.isFlags && clrNames.IndexOf(", ", StringComparison.Ordinal) >= 0)
            {
